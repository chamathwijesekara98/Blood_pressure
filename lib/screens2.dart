      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20), // space beetween
            ...
            Container(
              ...
              child: TextFormField(
                style: const TextStyle(
                    fontSize: 40, color: Color.fromARGB(255, 53, 13, 13)),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                shadowColor: const Color.fromRGBO(28, 23, 23, 0.69),
              ),
              child: const Text(
                'Validate',
                style: TextStyle(
        ...
        child: BottomAppBar(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                icon: const Icon(Icons.home), // bottom icon right
                color: const Color.fromARGB(255, 0, 0, 0),
                iconSize: 30,
                onPressed: () {},
              ),
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Image.asset('assets/heart1.jpg'),
              ),
